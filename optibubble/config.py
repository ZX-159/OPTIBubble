...
def app_root() -> Path:
    ...
    * **Frozen bundle** (PyInstaller / native Tauri installer): the directory the
    ...
    This is what makes one codebase work identically from source, from a PyInstaller
    onefile binary, and inside the Flatpak sandbox.
    """
    ...
    # source / Flatpak: parent of this module's directory is the project root
...
def default_data_dir() -> Path:
    ...
    1. ``XDG_DATA_HOME/OPTIBubbleData`` — honoured by Linux desktops, Flatpak and
       other sandboxes (the Flatpak launcher already passes this path explicitly).
